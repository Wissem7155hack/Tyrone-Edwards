        ...
        <div className="relative h-screen w-full flex flex-col justify-center items-center px-6 overflow-hidden">
          ...
          <div className="relative z-10 text-center flex flex-col items-center top-[-40px]">
            <span className="text-[#c5a26a] font-bold tracking-[0.4em] text-[10px] uppercase mb-4 animate-[fadeInUp_0.8s_ease-out]">
              Expert Landscaping & Garden Maintenance
            </span>
            <h1 className="text-6xl font-serif text-white leading-[1.1] animate-[fadeInUp_1s_ease-out] drop-shadow-lg">
              Tyrone <br />
              <span className="text-[#c5a26a] italic font-light block mt-2">Edwards</span>
            </h1>
            ...
            <p className="text-white text-lg leading-relaxed max-w-[340px] mx-auto my-8 animate-[fadeInUp_1.3s_ease-out] font-medium drop-shadow-md">
              Specializing in garden maintenance, landscaping design, retaining walls, and complete outdoor transformations. Call 0400 000 000 for a free quote!
            </p>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-white leading-[1.1] drop-shadow-2xl mb-6 md:mb-8 animate-[fadeInUp_1.2s_ease-out_forwards]">
                Tyrone
                <br />
                <span className="italic font-light text-gold-400">Edwards</span>
              </h1>
              ...
              <p className="text-lg md:text-xl text-gray-200 font-light max-w-2xl border-l-2 border-gold-500 pl-4 md:pl-6 mb-8 md:mb-10 animate-[fadeInUp_1.4s_ease-out_forwards] mx-auto lg:mx-0">
                We specialize in garden design, lawn care, retaining walls, and complete landscape transformations. Contact us at 0400 000 000 for a free quote in Alexandra Hills & Redland Bay!
              </p>
        ...
        <RevealOnScroll>
          <div className="relative w-full max-w-lg mx-auto lg:mx-0">
            ...
            <div className="absolute -bottom-6 -right-6 md:-bottom-10 md:-right-10 bg-white text-earth-900 p-4 md:p-8 shadow-xl max-w-xs hidden lg:block z-20">
              ...
              <p className="text-right mt-2 md:mt-4 font-bold text-gold-600 text-xs md:text-sm tracking-widest">— Tyrone Edwards</p>
            </div>
          </div>
        </RevealOnScroll>
        ...
        <div className="lg:w-1/2 space-y-6 md:space-y-8 mt-8 lg:mt-0">
          <RevealOnScroll delay={200}>
            ...
            <p className="text-gray-300 text-base md:text-lg font-light leading-relaxed mt-4 md:mt-6">
              We are a dedicated landscaping team in Queensland, Australia, committed to transforming outdoor spaces. Whether you need garden maintenance, retaining walls, new turf, or complete landscape design – we've got you covered. Serving Alexandra Hills, Redland Bay, and surrounding areas. Contact us at 0400 000 000 for a free quote!
            </p>
            ...
            <div className="flex items-center gap-4 md:gap-6 p-4 md:p-6 bg-white/5 border border-white/10 rounded-sm mt-6 md:mt-8 backdrop-blur-sm hover:bg-white/10 transition-colors">
              <img
                src={img25}
                alt="Tyrone Edwards"
                className="w-32 h-32 md:w-35 md:h-24 object-cover border-2 border-gold-500 shadow-md"
              />
              <div>
                <h4 className="text-lg md:text-xl font-serif text-white">Tyrone Edwards</h4>
                <p className="text-gold-500 text-xs font-bold uppercase tracking-widest mb-1 md:mb-2">Landscaping & Garden Design</p>
                <p className="text-gray-400 text-xs italic">"Quality garden services you can trust."</p>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 mt-6 md:mt-8">
              {[
                ...
                { title: "Free Quotes", desc: "Call or text (your phone number) for a free estimate on your project." },
...
const Testimonials = () => {
  ...
  const allReviews = [
    { name: "Mark T.", location: "Alexandra Hills, QLD", rating: 5, time: "1 month ago", text: "Tyrone did an incredible job on our retaining wall. Professional, efficient, and the result is solid. Highly recommend him for any landscaping work in the Redlands." },
    { name: "David L.", location: "Redland Bay, QLD", rating: 5, time: "2 months ago", text: "Hired Tyrone for a complete garden cleanup and new mulch. He transformed our yard in a single day. Very impressed with the attention to detail." },
    { name: "Sarah J.", location: "Cleveland, QLD", rating: 5, time: "3 months ago", text: "Excellent communication and fantastic work on our new path. Tyrone is top notch and very reliable. Our backyard looks like a resort now!" },
    { name: "Mike R.", location: "Victoria Point, QLD", rating: 5, time: "4 months ago", text: "Needed someone for regular lawn maintenance and hedge trimming. Tyrone has been great – always shows up on time and does a perfect job." },
    { name: "Jennifer P.", location: "Capalaba, QLD", rating: 5, time: "5 months ago", text: "Transformational work on our property. The garden design and plant selection are exactly what we wanted. Fair pricing and great service." },
    { name: "Robert K.", location: "Birkdale, QLD", rating: 5, time: "6 months ago", text: "Excellent service! We needed a small retaining wall replaced and Tyrone handled it quickly and left the site spotless. Highly recommended." }
  ];
...
const InteractiveMap = () => (
  <div className="w-full h-[300px] md:h-[500px] relative">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14151.4!2d153.218!3d-27.525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b91436449175d4b%3A0x502a35af3de7fb0!2sAlexandra%20Hills%20QLD%204161%2C%20Australia!5e0!3m2!1sen!2sau!4v1707923456789!5m2!1sen!2sau"
      width="100%"
      height="100%"
      style={{ border: 0 }}
      allowFullScreen
      ...
      title="Location in Alexandra Hills, QLD"
...
const HomePage = () => (
  <>
    <SEOHead
      title="Tyrone Edwards – Professional Construction & Hardscaping"
      ...
      keywords="hardscaping, retaining walls, excavation, landscape construction, patio installation, tree removal, Tyrone Edwards"
    />
    <Hero />
    <ServicesSection />
    <AboutPreview />
...
const ServicesPage = () => (
  <>
    <SEOHead
      title="Our Services – Landscaping & Maintenance | Tyrone Edwards"
      description="Professional landscaping and garden maintenance services: ✓ Garden Design ✓ Retaining Walls ✓ Lawn Mowing ✓ Clean-ups. Quality service in Redland City."
      keywords="landscaping services, garden maintenance, lawn mowing, garden design, Redland Bay, Alexandra Hills"
    />
    <PageHeader
      title="Our Services"
    ...
    <section className="py-12 md:py-20 bg-earth-900 text-center text-white">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-serif mb-4 md:mb-6">Ready to Transform Your Garden?</h2>
        <p className="text-gray-300 mb-4 text-sm md:text-base">Tyrone Edwards is ready to help with your next project:</p>
        <ul className="text-gray-300 text-sm md:text-base mb-6 md:mb-8 max-w-2xl mx-auto text-left space-y-2">
          <li>✓ Garden Maintenance & Clean-ups</li>
          <li>✓ Lawn Mowing & Edging</li>
          <li>✓ Retaining Walls & Hardscaping</li>
          <li>✓ Garden Design & Softscaping</li>
          <li>✓ Hedge Trimming & Pruning</li>
          <li>✓ Turf Installation</li>
        </ul>
        <p className="text-gold-500 font-bold text-lg mb-6">Call or message: 0400 000 000</p>
...
const ProjectsPage = () => (
  <>
    <SEOHead
      title="Projects & Gallery – Hardscaping Work | Tyrone Edwards"
...
const AboutPage = () => (
  <>
    <SEOHead
      title="About Us – Your Hardscaping Experts | Tyrone Edwards"
      description="Learn more about Tyrone Edwards. Your reliable partner for hardscaping and construction with professional service and guaranteed satisfaction."
      keywords="hardscaping company, landscape construction, Tyrone Edwards, professional excavators, retaining wall experts"
    />
    <PageHeader
      title="About Us"
      subtitle="Our Story"
        ...
        <div className="prose prose-sm md:prose-lg prose-stone mx-auto">
          ...
          <div className="flex flex-col items-center mb-8 md:mb-12">
            ...
            <div className="mt-4 md:mt-6 text-center">
              <h4 className="text-xl md:text-2xl font-serif text-earth-900">Tyrone Edwards</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 md:py-12 text-center border-y border-gray-200 my-8 md:my-12">
            <div>
              <span className="block text-2xl md:text-4xl font-serif text-gold-500 mb-1 md:mb-2">4+</span>
          ...
          <div className="bg-stone-50 p-6 md:p-8 rounded-lg mt-8 md:mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
              <div>
                ...
                <a href="tel:0400000000" className="text-earth-900 hover:text-gold-500 transition-colors font-bold">0400 000 000</a>
              </div>
              <div>
                <Send className="w-6 h-6 text-gold-500 mx-auto mb-2" />
                <a href="mailto:tyrone@tyroneedwardslandscaping.com.au" className="text-earth-900 hover:text-gold-500 transition-colors">tyrone@tyroneedwardslandscaping.com.au</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Serving Alexandra Hills, Redland Bay & Surrounding Areas<br />Cleveland, Victoria Point, Capalaba, Birkdale</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:0400000000" className="text-earth-900 hover:text-gold-500 transition-colors font-bold text-lg">0400 000 000</a>
                  <p className="text-gray-600 text-sm mt-1">Call or message for a free quote!</p>
                </div>
              </div>
...
const BlogListPage = () => (
  <>
    <SEOHead
      title="Blog & Guides – Landscaping Tips | Tyrone Edwards"
      description="Valuable tips on landscape design, garden maintenance, and hardscaping from your local experts in Alexandra Hills & Redland Bay. ✓ Expert Advice ✓ Project Showcases ✓ Professional Quality."
      keywords="Landscaping tips, garden maintenance guide, Alexandra Hills landscaping, Redland Bay garden care"
    />
    <PageHeader
      title="Blog & Guides"
...
const BlogPostPage = () => {
  ...
  return (
    <>
      <SEOHead
        title={`${post.title} – Landscaping Blog | Tyrone Edwards`}
        description={post.excerpt}
        keywords={`${post.title}, Landscaping Tips, Garden Guide, Redland Bay, ${post.slug}`}
          ...
          <RevealOnScroll delay={600}>
            <div className="mt-16 md:mt-20 p-8 md:p-12 bg-earth-900 text-white text-center rounded-lg">
              ...
              <p className="text-gray-300 mb-6 md:mb-8">
                As your local landscaping expert in the Redland City area, I am here to help with advice and action.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="tel:0400000000" className="inline-flex items-center px-8 py-4 bg-gold-500 hover:bg-gold-600 text-earth-900 font-bold uppercase tracking-widest transition-colors">
...
const FullGalleryPage = () => {
  ...
  // SEO effect
  useEffect(() => {
    document.title = "Gallery – Our Work in Pictures | Tyrone Edwards";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Browse through our image gallery: Garden designs, patio transformations, before-after pictures and more from Redland City and surroundings.");
  }, []);
          ...
          <div className="mt-20 md:mt-28 p-8 md:p-12 bg-stone-50 border-l-4 border-gold-500 rounded-lg">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 text-base md:text-lg mb-6 leading-relaxed">
                Every project in this gallery showcases our commitment to quality craftsmanship and beautiful design. From garden beds and hardscaping to lush turf installations and professional maintenance – discover the possibilities for transforming your outdoor space in Alexandra Hills and surrounding areas.
              </p>
