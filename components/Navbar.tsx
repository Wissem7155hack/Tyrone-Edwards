        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <Link to={NavigationLinks.HOME} className="flex flex-col items-center group z-50">
              <div className={`flex items-center ${logoColor} group-hover:${hoverColor} transition-colors`}>
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-serif font-bold leading-none">Tyrone Edwards</span>
                </div>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-4 lg:space-x-6 pl-4 lg:pl-8 lg:border-l lg:border-white/20">
              <a href="tel:0400000000" className="flex items-center text-gold-500 hover:text-white transition-colors group">
                ...
                <span className={`text-sm font-bold tracking-wide ${textColor} group-hover:text-gold-500 transition-colors`}>0400 000 000</span>
              </a>
            </div>
        ...
        <div className={`fixed inset-0 bg-[#1a261b] transform transition-transform duration-500 ease-in-out z-40 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col items-center justify-center h-full space-y-8 pt-16">
            ...
            <div className="mt-12 flex flex-col items-center space-y-4 border-t border-white/10 pt-12 w-48">
              <a href="mailto:tyrone@tyroneedwardslandscaping.com.au" className="flex flex-col items-center text-gold-500">
                <span className="text-xl font-serif text-white text-center">tyrone@tyroneedwardslandscaping.com.au</span>
              </a>
              <a href="tel:0400000000" className="flex flex-col items-center text-gold-500">
                <Phone size={32} className="mb-2" />
                <span className="text-xl font-serif text-white">0400 000 000</span>
              </a>
            </div>
          </div>
        </div>
